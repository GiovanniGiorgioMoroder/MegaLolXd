...
package net.mcreator.gbsadventure.world.dimension;
...
import net.mcreator.gbsadventure.item.VoidDimensionItem;
import net.mcreator.gbsadventure.block.COBBLEVOIDBlock;
...
public class VoidDimensionDimension extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:void_dimension_portal")
	public static final CustomPortalBlock portal = null;
	public VoidDimensionDimension(GbsAdventureModElements instance) {
		super(instance, 52);
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(COBBLEVOIDBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("gbs_adventure:void_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
			...
			if (!entity.isPassenger() && !entity.isBeingRidden() && entity.isNonBoss() && !entity.world.isRemote && true) {
				if (entity.func_242280_ah()) {
					entity.func_242279_ag();
						...
						new ResourceLocation("gbs_adventure:void_dimension"))) {
					entity.func_242279_ag();
					teleportToDimension(entity, pos,
							RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("gbs_adventure:void_dimension")));
				} else {
					entity.func_242279_ag();
