...
public class DarkcalamityItem extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:darkcalamity")
	public static final Item block = null;
	public DarkcalamityItem(GbsAdventureModElements instance) {
		super(instance, 30);
	}
