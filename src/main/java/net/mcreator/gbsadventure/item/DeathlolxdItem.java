...
public class DeathlolxdItem extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:deathlolxd")
	public static final Item block = null;
	public DeathlolxdItem(GbsAdventureModElements instance) {
		super(instance, 34);
	}
