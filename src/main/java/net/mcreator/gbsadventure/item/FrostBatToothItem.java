...
public class FrostBatToothItem extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:frost_bat_tooth")
	public static final Item block = null;
	public FrostBatToothItem(GbsAdventureModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("frost_bat_tooth");
		}
