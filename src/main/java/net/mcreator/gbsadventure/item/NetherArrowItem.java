...
public class NetherArrowItem extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:nether_arrow")
	public static final Item block = null;
	public NetherArrowItem(GbsAdventureModElements instance) {
		super(instance, 22);
	}
