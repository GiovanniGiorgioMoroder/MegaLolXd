...
public class RuniumItem extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:runium")
	public static final Item block = null;
	public RuniumItem(GbsAdventureModElements instance) {
		super(instance, 16);
	}
