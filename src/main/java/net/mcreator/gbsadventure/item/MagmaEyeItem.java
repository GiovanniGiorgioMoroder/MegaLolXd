...
public class MagmaEyeItem extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:magma_eye")
	public static final Item block = null;
	public MagmaEyeItem(GbsAdventureModElements instance) {
		super(instance, 14);
	}
