...
public class PlatinumOreBlock extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:platinum_ore")
	public static final Block block = null;
	public PlatinumOreBlock(GbsAdventureModElements instance) {
		super(instance, 10);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(2.1999999999999997f, 10f).setLightLevel(s -> 15)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("gbs_adventure:platinum_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("gbs_adventure:platinum_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
