...
public class VOIDLOGBlock extends GbsAdventureModElements.ModElement {
	@ObjectHolder("gbs_adventure:voidlog")
	public static final Block block = null;
	public VOIDLOGBlock(GbsAdventureModElements instance) {
		super(instance, 53);
	}
